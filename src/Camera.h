...
static const float defaultMoveSensitivity = 1.0f; // 移动灵敏度
static const float defaultZoomSensitivity = 100.0f; // 缩放灵敏度
static const float defaultEulerSensitivity = 50.0f; // 欧拉角灵敏度
