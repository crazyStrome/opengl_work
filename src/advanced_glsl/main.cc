...
int main()
{
    ...
    unsigned int uniformLightIndex = glGetUniformBlockIndex(lightShader.ID, "Matrics");
    unsigned int uniformObjectIndex = glGetUniformBlockIndex(objectShader.ID, "Matrics");

    glUniformBlockBinding(lightShader.ID, uniformLightIndex, 0);
    glUniformBlockBinding(objectShader.ID, uniformObjectIndex, 0);
    ...
    unsigned int diffuseMap = loadTexture("../../source/picture/container2.png");
    unsigned int specularMap = loadTexture("../../source/picture/matrix.jpg");
